...
public class DigraphEdgeList<V, E> implements Digraph<V, E> {
    ...
    public synchronized Edge<E, V> insertEdge(Vertex<V> outbound, Vertex<V> inbound, E edgeElement) throws InvalidVertexException, InvalidEdgeException {
        ...
        MyEdge newEdge = new MyEdge( outVertex, inVertex,edgeElement);
    ...
    @Override
    public synchronized Edge<E, V> insertEdge(V outboundElement, V targetElement, E edgeElement) throws InvalidVertexException, InvalidEdgeException {
        MyVertex outVertex = checkVertex( vertices.get(outboundElement));
        MyVertex inVertex = checkVertex( vertices.get(targetElement));


        MyEdge newEdge = new MyEdge( outVertex, inVertex,edgeElement);

        edges.add( newEdge);
        outVertex.getOutgoingEdges().put(inVertex,newEdge);
        inVertex.getIncomingEdges().put(outVertex,newEdge);
    ...
    private class MyVertex implements Vertex<V> {
        ...
        V element;
        Map<Vertex<V>, Edge<E, V>> outgoingEdges, incomingEdges;
    ...
    private class MyEdge implements Edge<E, V> {
        ...
        public MyEdge( Vertex<V> vertexOutbound, Vertex<V> vertexInbound,E element) {
            this.element = element;
